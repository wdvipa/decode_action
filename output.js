//Wed Jun 18 2025 16:38:11 GMT+0000 (Coordinated Universal Time)
//Base:<url id="cv1cref6o68qmpt26ol0" type="url" status="parsed" title="GitHub - echo094/decode-js: JS混淆代码的AST分析工具 AST analysis tool for obfuscated JS code" wc="2165">https://github.com/echo094/decode-js</url>
//Modify:<url id="cv1cref6o68qmpt26olg" type="url" status="parsed" title="GitHub - smallfawn/decode_action: 世界上本来不存在加密，加密的人多了，也便成就了解密" wc="741">https://github.com/smallfawn/decode_action</url>
(self.webpackChunkcombination_template = self.webpackChunkcombination_template || []).push([[7515], {
  17515: function (module) {
    var t;
    window, t = function () {
      return function (e) {
        function t(i) {
        ...
        return t.m = e, t.c = r, t.d = function (e, r, i) {
          ...
          if (t.r(i), Object.defineProperty(i, "default", {
            enumerable: true,
            value: e
          }), 2 & r && "string" != typeof e) for (var n in e) t.d(i, n, function (t) {
            return e[t];
          }.bind(null, n));
          return i;
        }, t.n = function (e) {
        ...
        o.decorateEnum = function (e) {
          ...
          return function e(t, r, i) {
            var n = r.shift();
            if (r.length > 0) t[n] = e(t[n] || {}, r, i);else {
              var o = t[n];
        ...
        (function (e) {
          function i(e, t, r) {
            for (var i = Object.keys(t), n = 0; n < i.length; ++n) undefined !== e[i[n]] && r || (e[i[n]] = t[i[n]]);
            return e;
          }
          function n(e) {
            function t(e, r) {
          ...
          var o = t;
          o.asPromise = r(17), o.base64 = r(38), o.EventEmitter = r(39), o.float = r(40), o.inquire = r(18), o.utf8 = r(41), o.pool = r(42), o.LongBits = r(43), o.isNode = Boolean(undefined !== e && e && e.process && e.process.versions && e.process.versions.node), o.global = o.isNode && e || "undefined" != typeof window && window || "undefined" != typeof self && self || this, o.emptyArray = Object.freeze ? Object.freeze([]) : [], o.emptyObject = Object.freeze ? Object.freeze({}) : {}, o.isInteger = Number.isInteger || function (e) {
            ...
            return function () {
              for (var e = Object.keys(this), r = e.length - 1; r > -1; --r) if (1 === t[e[r]] && undefined !== this[e[r]] && null !== this[e[r]]) return e[r];
            };
        ...
        function i(e, t, r, i, o) {
          ...
          if (this.valuesById = {}, this.values = Object.create(this.valuesById), this.comment = i, this.comments = o || {}, this.reserved = undefined, t) for (var s = Object.keys(t), a = 0; a < s.length; ++a) "number" == typeof t[s[a]] && (this.valuesById[this.values[s[a]] = t[s[a]]] = s[a]);
        }
        e.exports = i;
        var n = r(3);
        ...
        i.fromJSON = function (e, t) {
          ...
          if (undefined !== this.values[e]) throw Error("duplicate name '" + e + "' in " + this);
        ...
        function i(e, t) {
          ...
          this.options = t, this.parsedOptions = null, this.name = e, this.parent = null, this.resolved = false, this.comment = null, this.filename = null;
        }
        ...
        Object.defineProperties(i.prototype, {
          ...
          var t = e.root;
          t instanceof n && t._handleRemove(this), this.parent = null, this.resolved = false;
          ...
          return r && this.options && undefined !== this.options[e] || ((this.options || (this.options = {}))[e] = t), this;
        ...
        function i(e, t, r, i, o, s, u) {
          if (f.isObject(i) ? (u = o, s = i, i = o = undefined) : f.isObject(o) && (u = s, s = o, o = undefined), n.call(this, e, s), !f.isInteger(t) || t < 0) throw TypeError("id must be a non-negative integer");
          if (!f.isString(r)) throw TypeError("type must be a string");
          if (undefined !== i && !l.test(i = i.toString().toLowerCase())) throw TypeError("rule must be a string rule");
          if (undefined !== o && !f.isString(o)) throw TypeError("extend must be a string");
          this.rule = i && "optional" !== i ? i : undefined, this.type = r, this.id = t, this.extend = o || undefined, this.required = "required" === i, this.optional = !this.required, this.repeated = "repeated" === i, this.map = false, this.message = null, this.partOf = null, this.typeDefault = null, this.defaultValue = null, this.long = !!f.Long && undefined !== a.long[r], this.bytes = "bytes" === r, this.resolvedType = null, this.extensionField = null, this.declaringField = null, this._packed = null, this.comment = u;
        }
        e.exports = i;
        var n = r(3);
        ...
        i.fromJSON = function (e, t) {
          ...
          if (undefined === (this.typeDefault = a.defaults[this.type]) && (this.resolvedType = (this.declaringField ? this.declaringField.parent : this.parent).lookupTypeOrEnum(this.type), this.resolvedType instanceof o ? this.typeDefault = null : this.typeDefault = this.resolvedType.values[Object.keys(this.resolvedType.values)[0]]), this.options && null != this.options.default && (this.typeDefault = this.options.default, this.resolvedType instanceof s && "string" == typeof this.typeDefault && (this.typeDefault = this.resolvedType.values[this.typeDefault])), this.options && (true !== this.options.packed && (undefined === this.options.packed || !this.resolvedType || this.resolvedType instanceof s) || delete this.options.packed, Object.keys(this.options).length || (this.options = undefined)), this.long) this.typeDefault = f.Long.fromNumber(this.typeDefault, "u" === this.type.charAt(0)), Object.freeze && Object.freeze(this.typeDefault);else if (this.bytes && "string" == typeof this.typeDefault) {
            var e;
        ...
        function n(e, t) {
          s.call(this, e, t), this.nested = undefined, this._nestedArray = null;
        }
        function o(e) {
        ...
        n.fromJSON = function (e, t) {
          ...
          if (e) for (var r = 0; r < e.length; ++r) if ("string" != typeof e[r] && e[r][0] <= t && e[r][1] > t) return true;
          return false;
        }, n.isReservedName = function (e, t) {
          if (e) for (var r = 0; r < e.length; ++r) if (e[r] === t) return true;
          return false;
          ...
          if (e) for (var t, r = Object.keys(e), i = 0; i < r.length; ++i) t = e[r[i]], this.add((undefined !== t.fields ? a.fromJSON : undefined !== t.values ? l.fromJSON : undefined !== t.methods ? f.fromJSON : undefined !== t.id ? u.fromJSON : n.fromJSON)(r[i], t));
          return this;
          ...
          if (!(e instanceof u && undefined !== e.extend || e instanceof a || e instanceof l || e instanceof f || e instanceof n)) throw TypeError("object must be a valid nested object");
          if (this.nested) {
          ...
          if (h.isString(e)) e = e.split(".");else if (!Array.isArray(e)) throw TypeError("illegal path");
          ...
          if ("boolean" == typeof t ? (r = t, t = undefined) : t && !Array.isArray(t) && (t = [t]), h.isString(e) && e.length) {
          ...
          if (i) {
            ...
            } else if (i instanceof n && (i = i.lookup(e.slice(1), t, true))) return i;
          } else for (var o = 0; o < this.nestedArray.length; ++o) if (this._nestedArray[o] instanceof n && (i = this._nestedArray[o].lookup(e, t, true))) return i;
        ...
        var o = {
            arraySet: function (e, t, r, i, n) {
              if (t.subarray && e.subarray) e.set(t.subarray(r, r + i), n);else for (var o = 0; o < i; o++) e[n + o] = t[r + o];
            },
        ...
        n.create = d(), n.prototype._slice = l.Array.prototype.subarray || l.Array.prototype.slice, n.prototype.uint32 = function () {
          ...
          l.merge(n.prototype, {
            int64: function () {
              return o.call(this)[t](false);
            },
            uint64: function () {
              return o.call(this)[t](true);
            },
            sint64: function () {
              return o.call(this).zzDecode()[t](false);
            },
            fixed64: function () {
              return a.call(this)[t](true);
            },
            sfixed64: function () {
              return a.call(this)[t](false);
            }
          });
        };
      }, function (e, t, r) {
        ...
        function i(e, t, r, i) {
          if (Array.isArray(t) || (r = t, t = undefined), o.call(this, e, r), undefined !== t && !Array.isArray(t)) throw TypeError("fieldNames must be an Array");
        ...
        e.exports = function (e) {
          for (var t, r = s.codegen(["m", "w"], e.name + "$encode")("if(!w)")("w=Writer.create()"), a = e.fieldsArray.slice().sort(s.compareFieldsById), f = 0; f < a.length; ++f) {
            var l = a[f].resolve(),
              ...
              c = o.basic[h];
            t = "m" + s.safeProp(l.name), l.map ? (r("if(%s!=null&&Object.hasOwnProperty.call(m,%j)){", t, l.name)("for(var ks=Object.keys(%s),i=0;i<ks.length;++i){", t)("w.uint32(%i).fork().uint32(%i).%s(ks[i])", (l.id << 3 | 2) >>> 0, 8 | o.mapKey[l.keyType], l.keyType), undefined === c ? r("types[%i].encode(%s[ks[i]],w.uint32(18).fork()).ldelim().ldelim()", u, t) : r(".uint32(%i).%s(%s[ks[i]]).ldelim()", 16 | c, h, t), r("}")("}")) : l.repeated ? (r("if(%s!=null&&%s.length){", t, t), l.packed && undefined !== o.packed[h] ? r("w.uint32(%i).fork()", (l.id << 3 | 2) >>> 0)("for(var i=0;i<%s.length;++i)", t)("w.%s(%s[i])", h, t)("w.ldelim()") : (r("for(var i=0;i<%s.length;++i)", t), undefined === c ? i(r, l, u, t + "[i]") : r("w.uint32(%i).%s(%s[i])", (l.id << 3 | c) >>> 0, h, t)), r("}")) : (l.optional && r("if(%s!=null&&Object.hasOwnProperty.call(m,%j))", t, l.name), undefined === c ? i(r, l, u, t) : r("w.uint32(%i).%s(%s)", (l.id << 3 | c) >>> 0, h, t));
          }
          return r("return w");
        };
        var n = r(2),
        ...
        function i(e, t) {
          o.call(this, e, t), this.fields = {}, this.oneofs = undefined, this.extensions = undefined, this.reserved = undefined, this.group = undefined, this._fieldsById = null, this._fieldsArray = null, this._oneofsArray = null, this._ctor = null;
        }
        function n(e) {
        ...
        Object.defineProperties(i.prototype, {
          ...
          ctor: {
            ...
            set: function (e) {
              var t = e.prototype;
              t instanceof h || ((e.prototype = new h()).constructor = e, p.merge(e.prototype, t)), e.$type = e.prototype.$type = this, p.merge(e, h, true), this._ctor = e;
          ...
          for (var n = Object.keys(t.fields), h = 0; h < n.length; ++h) r.add((undefined !== t.fields[n[h]].keyType ? l.fromJSON : f.fromJSON)(n[h], t.fields[n[h]]));
          ...
          if (t.nested) for (n = Object.keys(t.nested), h = 0; h < n.length; ++h) {
            var c = t.nested[n[h]];
            r.add((undefined !== c.id ? f.fromJSON : undefined !== c.fields ? i.fromJSON : undefined !== c.values ? s.fromJSON : undefined !== c.methods ? u.fromJSON : o.fromJSON)(n[h], c));
          }
          ...
          return p.toObject(["options", t && t.options || undefined, "oneofs", o.arrayToJSON(this.oneofsArray, e), "fields", o.arrayToJSON(this.fieldsArray.filter(function (e) {
          ...
          if (e instanceof f && undefined === e.extend) {
        ...
        function i(e, t, r, i, o, a) {
          if (n.call(this, e, t, i, undefined, undefined, o, a), !s.isString(r)) throw TypeError("keyType must be a string");
        ...
        i.fromJSON = function (e, t) {
          ...
          if (this.resolved) return this;
          if (undefined === o.mapKey[this.keyType]) throw Error("invalid key type: " + this.keyType);
        ...
        i.fromJSON = function (e, t) {
          ...
          var t = o.prototype.toJSON.call(this, e),
            r = !!e && Boolean(e.keepComments);
          return a.toObject(["options", t && t.options || undefined, "methods", o.arrayToJSON(this.methodsArray, e) || {}, "nested", t && t.nested || undefined, "comment", r ? this.comment : undefined]);
        ...
        function i(e, t, r, i, s, a, f, l, u) {
          if (o.isObject(s) ? (f = s, s = a = undefined) : o.isObject(a) && (f = a, a = undefined), undefined !== t && !o.isString(t)) throw TypeError("type must be a string");
          ...
          n.call(this, e, f), this.type = t || "rpc", this.requestType = r, this.requestStream = !!s || undefined, this.responseType = i, this.responseStream = !!a || undefined, this.resolvedRequestType = null, this.resolvedResponseType = null, this.comment = l, this.parsedOptions = u;
        }
        e.exports = i;
        var n = r(3);
        ...
        i.fromJSON = function (e, t) {
          ...
          var t = !!e && Boolean(e.keepComments);
          return o.toObject(["type", "rpc" !== this.type && this.type || undefined, "requestType", this.requestType, "requestStream", this.requestStream, "responseType", this.responseType, "responseStream", this.responseStream, "options", this.options, "comment", t ? this.comment : undefined, "parsedOptions", this.parsedOptions]);
        }, i.prototype.resolve = function () {
        ...
        e.exports = function (e) {
          ...
          for (var r = 0; r < e.fieldsArray.length; ++r) {
            ...
            t("case %i:", a.id), a.map ? (t("if(%s===util.emptyObject)", l)("%s={}", l)("var c2 = r.uint32()+r.pos"), undefined !== o.defaults[a.keyType] ? t("k=%j", o.defaults[a.keyType]) : t("k=null"), undefined !== o.defaults[f] ? t("value=%j", o.defaults[f]) : t("value=null"), t("while(r.pos<c2){")("var tag2=r.uint32()")("switch(tag2>>>3){")("case 1: k=r.%s(); break", a.keyType)("case 2:"), undefined === o.basic[f] ? t("value=types[%i].decode(r,r.uint32())", r) : t("value=r.%s()", f), t("break")("default:")("r.skipType(tag2&7)")("break")("}")("}"), undefined !== o.long[a.keyType] ? t('%s[typeof k==="object"?util.longToHash(k):k]=value', l) : t("%s[k]=value", l)) : a.repeated ? (t("if(!(%s&&%s.length))", l, l)("%s=[]", l), undefined !== o.packed[f] && t("if((t&7)===2){")("var c2=r.uint32()+r.pos")("while(r.pos<c2)")("%s.push(r.%s())", l, f)("}else"), undefined === o.basic[f] ? t(a.resolvedType.group ? "%s.push(types[%i].decode(r))" : "%s.push(types[%i].decode(r,r.uint32()))", l, r) : t("%s.push(r.%s())", l, f)) : undefined === o.basic[f] ? t(a.resolvedType.group ? "%s=types[%i].decode(r)" : "%s=types[%i].decode(r,r.uint32())", l, r) : t("%s=r.%s()", l, f), t("break");
          }
        ...
        e.exports = function (e) {
          ...
          for (var s = 0; s < e.fieldsArray.length; ++s) {
            ...
            if (f.optional && t("if(%s!=null&&m.hasOwnProperty(%j)){", l, f.name), f.map) t("if(!util.isObject(%s))", l)("return%j", i(f, "object"))("var k=Object.keys(%s)", l)("for(var i=0;i<k.length;++i){"), o(t, f, "k[i]"), n(t, f, s, l + "[k[i]]")("}");else if (f.repeated) t("if(!Array.isArray(%s))", l)("return%j", i(f, "array"))("for(var i=0;i<%s.length;++i){", l), n(t, f, s, l + "[i]")("}");else {
              if (f.partOf) {
        ...
        function o(e, t) {
          ...
          if (r) {
            var i = new u(t.fullName, t.id, t.type, t.rule, undefined, t.options);
            ...
            try {
              if (d.isString(t) && "{" === t.charAt(0) && (t = JSON.parse(t)), d.isString(t)) {
                ...
                var i,
                  n = f(t, h, r),
                  a = 0;
                if (n.imports) for (; a < n.imports.length; ++a) (i = s(n.imports[a]) || h.resolvePath(e, n.imports[a])) && u(i);
                if (n.weakImports) for (a = 0; a < n.weakImports.length; ++a) (i = s(n.weakImports[a]) || h.resolvePath(e, n.weakImports[a])) && u(i, true);
        ...
        i.prototype._handleAdd = function (e) {
          if (e instanceof u) undefined === e.extend || e.extensionField || o(0, e) || this.deferred.push(e);else if (e instanceof h) p.test(e.name) && (e.parent[e.name] = e.values);else if (!(e instanceof c)) {
            if (e instanceof a) for (var t = 0; t < this.deferred.length;) o(0, this.deferred[t]) ? this.deferred.splice(t, 1) : ++t;
          ...
          if (e instanceof u) {
            if (undefined !== e.extend) if (e.extensionField) e.extensionField.parent.remove(e.extensionField), e.extensionField = null;else {
        ...
        t.VideoEntity = function () {
          function e(t, r) {
            (function (e, t) {
              ...
              width: 0,
              height: 0
            }, this.FPS = 20, this.frames = 0, this.images = {}, this.sprites = [], this.audios = [], "object" === (undefined === t ? "undefined" : i(t)) && t.$type == s ? ("object" === i(t.params) && (this.version = t.ver, this.videoSize.width = t.params.viewBoxWidth || 0, this.videoSize.height = t.params.viewBoxHeight || 0, this.FPS = t.params.fps || 20, this.frames = t.params.frames || 0), this.resetSprites(t), this.audios = t.audios) : t && (t.movie && (t.movie.viewBox && (this.videoSize.width = parseFloat(t.movie.viewBox.width) || 0, this.videoSize.height = parseFloat(t.movie.viewBox.height) || 0), this.version = t.ver, this.FPS = parseInt(t.movie.fps) || 20, this.frames = parseInt(t.movie.frames) || 0), this.resetSprites(t)), r && (this.images = r);
          }
          return n(e, [{
            key: "resetSprites",
            value: function (e) {
        ...
        t.FrameEntity = function e(t) {
          (function (e, t) {
            ...
            width: 0,
            height: 0
          }, this.nx = 0, this.ny = 0, this.maskPath = null, this.shapes = [], this.alpha = parseFloat(t.alpha) || 0, t.layout && (this.layout.x = parseFloat(t.layout.x) || 0, this.layout.y = parseFloat(t.layout.y) || 0, this.layout.width = parseFloat(t.layout.width) || 0, this.layout.height = parseFloat(t.layout.height) || 0), t.transform && (this.transform.a = parseFloat(t.transform.a) || 1, this.transform.b = parseFloat(t.transform.b) || 0, this.transform.c = parseFloat(t.transform.c) || 0, this.transform.d = parseFloat(t.transform.d) || 1, this.transform.tx = parseFloat(t.transform.tx) || 0, this.transform.ty = parseFloat(t.transform.ty) || 0), t.clipPath && t.clipPath.length > 0 && (this.maskPath = new i.BezierPath(t.clipPath, undefined, {
            fill: "#000000"
        ...
        i.encode = function (e, t, r) {
          ...
          for (var i, n = r, s = 0, a = 0; a < e.length;) {
            ...
            if (61 === f && s > 1) break;
            if (undefined === (f = o[f])) throw Error("invalid encoding");
            switch (s) {
              case 0:
                i = f, s = 1;
                break;
        ...
        e.exports = i, i.prototype.on = function (e, t, r) {
          ...
          if (undefined === e) this._listeners = {};else if (undefined === t) this._listeners[e] = [];else for (var r = this._listeners[e], i = 0; i < r.length;) r[i].fn === t ? r.splice(i, 1) : ++i;
          return this;
        ...
        function i(e) {
          return "undefined" != typeof Float32Array ? function () {
            ...
            function t(e, t, r, i) {
              var n = t < 0 ? 1 : 0;
              if (n && (t = -t), 0 === t) e(1 / t > 0 ? 0 : 2147483648, r, i);else if (isNaN(t)) e(2143289344, r, i);else if (t > 34028234663852886e22) e((n << 31 | 2139095040) >>> 0, r, i);else if (t < 11754943508222875e-54) e((n << 31 | Math.round(t / 1401298464324817e-60)) >>> 0, r, i);else {
            ...
            function r(e, t, r) {
              var i = e(t, r),
                ...
                o = i >>> 23 & 255,
                s = 8388607 & i;
              return 255 === o ? s ? NaN : n * Infinity : 0 === o ? 1401298464324817e-60 * n * s : n * Math.pow(2, o - 150) * (s + 8388608);
            }
            ...
            function t(e, t, r, i, n, o) {
              var s = i < 0 ? 1 : 0;
              if (s && (i = -i), 0 === i) e(0, n, o + t), e(1 / i > 0 ? 0 : 2147483648, n, o + r);else if (isNaN(i)) e(0, n, o + t), e(2146959360, n, o + r);else if (i > 17976931348623157e292) e(0, n, o + t), e((s << 31 | 2146435072) >>> 0, n, o + r);else {
                var a;
                if (i < 22250738585072014e-324) e((a = i / 5e-324) >>> 0, n, o + t), e((s << 31 | a / 4294967296) >>> 0, n, o + r);else {
            ...
            function r(e, t, r, i, n) {
              ...
              return 2047 === f ? l ? NaN : a * Infinity : 0 === f ? 5e-324 * a * l : a * Math.pow(2, f - 1075) * (l + 4503599627370496);
            }
          ...
          l = {
            loadAssets: function (e, t, r) {
              if ("object" === ("undefined" == typeof JSZipUtils ? "undefined" : i(JSZipUtils)) && "function" == typeof JSZip) {
                ...
                } else e.indexOf("data:svga/2.0;base64,") >= 0 ? (n = l._base64ToArrayBuffer(e.substring(21)), l.load_viaProto(n, t, r)) : JSZipUtils.getBinaryContent(e, function (e, i) {
                  if (e) throw r && r(e), e;
                ...
                o.open("GET", e, true), o.responseType = "arraybuffer", o.onload = function () {
            ...
            load_viaProto: function (e, t, r) {
              try {
                var i = a.inflate(e),
                  o = n.decode(i),
                  s = {};
                l._loadImages(s, undefined, o, function () {
                  o.ver = "2.0", t({
                    movie: o,
                    images: s
                  });
            ...
            _decodeAssets: function (e, t) {
              e.file("movie.binary"), e.file("movie.spec").async("string").then(function (i) {
                var n = JSON.parse(i),
                  o = {};
                n.ver = "1.5", l._loadImages(o, e, n, function () {
                  t({
                    movie: n,
                    images: o
                  });
            ...
            _loadImages: function (e, t, r, o) {
              var s = this;
              if ("object" === (undefined === r ? "undefined" : i(r)) && r.$type == n) {
                var a = true;
                if (t) e: for (var u in r.images) switch (function (i) {
                  if (r.images.hasOwnProperty(i)) {
                    var n = r.images[i],
                      u = f(n);
                    return e.hasOwnProperty(i) ? "continue" : (a = false, t.file(u + ".png").async("base64").then(function (n) {
                  ...
                  case "break":
                    break e;
                } else for (var h in r.images) if (r.images.hasOwnProperty(h)) {
                  var c = r.images[h],
                    d = undefined;
                  try {
                    d = f(c);
                ...
                for (var p in a = true, r.images) if (r.images.hasOwnProperty(p)) {
                  var y = r.images[p];
                  if (e.hasOwnProperty(p)) continue;
                  a = false, t.file(y + ".png").async("base64").then(function (i) {
        ...
        function i(e) {
          ...
          var t = this.options;
          t.raw && t.windowBits >= 0 && t.windowBits < 16 && (t.windowBits = -t.windowBits, 0 === t.windowBits && (t.windowBits = -15)), !(t.windowBits >= 0 && t.windowBits < 16) || e && e.windowBits || (t.windowBits += 32), t.windowBits > 15 && t.windowBits < 48 && !(15 & t.windowBits) && (t.windowBits |= 15), this.err = 0, this.msg = "", this.ended = false, this.chunks = [], this.strm = new u(), this.strm.avail_out = 0;
        ...
        function n(e, t) {
          var r = new i(t);
          if (r.push(e, true), r.err) throw r.msg || l[r.err];
          return r.result;
        }
        var o = r(52),
          s = r(8),
        ...
        i.prototype.push = function (e, t) {
          ...
          i = t === ~~t ? t : true === t ? f.Z_FINISH : f.Z_NO_FLUSH, "string" == typeof e ? h.input = a.binstring2buf(e) : "[object ArrayBuffer]" === c.call(e) ? h.input = new Uint8Array(e) : h.input = e, h.next_in = 0, h.avail_in = h.input.length;
          do {
            if (0 === h.avail_out && (h.output = new s.Buf8(d), h.next_out = 0, h.avail_out = d), (r = o.inflate(h, f.Z_NO_FLUSH)) === f.Z_NEED_DICT && p && (r = o.inflateSetDictionary(this.strm, p)), r === f.Z_BUF_ERROR && true === y && (r = f.Z_OK, y = false), r !== f.Z_STREAM_END && r !== f.Z_OK) return this.onEnd(r), this.ended = true, false;
            h.next_out && (0 !== h.avail_out && r !== f.Z_STREAM_END && (0 !== h.avail_in || i !== f.Z_FINISH && i !== f.Z_SYNC_FLUSH) || ("string" === this.options.to ? (n = a.utf8border(h.output, h.next_out), l = h.next_out - n, u = a.buf2string(h.output, n), h.next_out = l, h.avail_out = d - l, l && s.arraySet(h.output, h.output, n, l, 0), this.onData(u)) : this.onData(s.shrinkBuf(h.output, h.next_out)))), 0 === h.avail_in && 0 === h.avail_out && (y = true);
          } while ((h.avail_in > 0 || 0 === h.avail_out) && r !== f.Z_STREAM_END);
          return r === f.Z_STREAM_END && (i = f.Z_FINISH), i === f.Z_FINISH ? (r = o.inflateEnd(this.strm), this.onEnd(r), this.ended = true, r === f.Z_OK) : i !== f.Z_SYNC_FLUSH || (this.onEnd(f.Z_OK), h.avail_out = 0, true);
        ...
        function o(e) {
          var t;
          return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = k, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new d.Buf32(A), t.distcode = t.distdyn = new d.Buf32(S), t.sane = 1, t.back = -1, _) : w;
        }
        function s(e) {
          var t;
        ...
        function a(e, t) {
          var r, i;
          return e && e.state ? (i = e.state, t < 0 ? (r = 0, t = -t) : (r = 1 + (t >> 4), t < 48 && (t &= 15)), t && (t < 8 || t > 15) ? w : (null !== i.window && i.wbits !== t && (i.window = null), i.wrap = r, i.wbits = t, s(e))) : w;
        }
        function f(e, t) {
          var r, i;
          return e ? (i = new n(), e.state = i, i.window = null, (r = a(e, t)) !== _ && (e.state = null), r) : w;
        }
        function l(e) {
          if (j) {
            var t;
        ...
        t.inflateReset = s, t.inflateReset2 = a, t.inflateResetKeep = o, t.inflateInit = function (e) {
          ...
          (r = e.state).mode === x && (r.mode = 13), a = e.next_out, o = e.output, h = e.avail_out, s = e.next_in, n = e.input, f = e.avail_in, c = r.hold, A = r.bits, S = f, j = h, M = _;
          e: for (;;) switch (r.mode) {
            case k:
              if (0 === r.wrap) {
                r.mode = 13;
              ...
              if (2 & r.wrap && 35615 === c) {
                r.check = 0, U[0] = 255 & c, U[1] = c >>> 8 & 255, r.check = y(r.check, U, 2, 0), c = 0, A = 0, r.mode = 2;
                break;
              }
              if (r.flags = 0, r.head && (r.head.done = false), !(1 & r.wrap) || (((255 & c) << 8) + (c >> 8)) % 31) {
                e.msg = "incorrect header check", r.mode = O;
                break;
              }
              if (8 != (15 & c)) {
                e.msg = "unknown compression method", r.mode = O;
                break;
              }
              if (A -= 4, D = 8 + (15 & (c >>>= 4)), 0 === r.wbits) r.wbits = D;else if (D > r.wbits) {
                e.msg = "invalid window size", r.mode = O;
                break;
              }
              r.dmax = 1 << D, e.adler = r.check = 1, r.mode = 512 & c ? 10 : x, c = 0, A = 0;
              break;
            case 2:
              for (; A < 16;) {
                if (0 === f) break e;
              ...
              if (57344 & r.flags) {
                e.msg = "unknown header flags set", r.mode = O;
                break;
              }
              r.head && (r.head.text = c >> 8 & 1), 512 & r.flags && (U[0] = 255 & c, U[1] = c >>> 8 & 255, r.check = y(r.check, U, 2, 0)), c = 0, A = 0, r.mode = 3;
            case 3:
              for (; A < 32;) {
                if (0 === f) break e;
                f--, c += n[s++] << A, A += 8;
              }
              r.head && (r.head.time = c), 512 & r.flags && (U[0] = 255 & c, U[1] = c >>> 8 & 255, U[2] = c >>> 16 & 255, U[3] = c >>> 24 & 255, r.check = y(r.check, U, 4, 0)), c = 0, A = 0, r.mode = 4;
            case 4:
              for (; A < 16;) {
                if (0 === f) break e;
                f--, c += n[s++] << A, A += 8;
              }
              r.head && (r.head.xflags = 255 & c, r.head.os = c >> 8), 512 & r.flags && (U[0] = 255 & c, U[1] = c >>> 8 & 255, r.check = y(r.check, U, 2, 0)), c = 0, A = 0, r.mode = 5;
            case 5:
              if (1024 & r.flags) {
                for (; A < 16;) {
                  if (0 === f) break e;
                ...
                r.length = c, r.head && (r.head.extra_len = c), 512 & r.flags && (U[0] = 255 & c, U[1] = c >>> 8 & 255, r.check = y(r.check, U, 2, 0)), c = 0, A = 0;
              } else r.head && (r.head.extra = null);
              r.mode = 6;
            case 6:
              if (1024 & r.flags && ((T = r.length) > f && (T = f), T && (r.head && (D = r.head.extra_len - r.length, r.head.extra || (r.head.extra = new Array(r.head.extra_len)), d.arraySet(r.head.extra, n, s, T, D)), 512 & r.flags && (r.check = y(r.check, n, T, s)), f -= T, s += T, r.length -= T), r.length)) break e;
              r.length = 0, r.mode = 7;
            case 7:
              if (2048 & r.flags) {
                if (0 === f) break e;
                T = 0;
                do {
                  D = n[s + T++], r.head && D && r.length < 65536 && (r.head.name += String.fromCharCode(D));
                } while (D && T < f);
                if (512 & r.flags && (r.check = y(r.check, n, T, s)), f -= T, s += T, D) break e;
            ...
            case 8:
              if (4096 & r.flags) {
                ...
                T = 0;
                do {
                  D = n[s + T++], r.head && D && r.length < 65536 && (r.head.comment += String.fromCharCode(D));
                } while (D && T < f);
                if (512 & r.flags && (r.check = y(r.check, n, T, s)), f -= T, s += T, D) break e;
            ...
            case 9:
              if (512 & r.flags) {
                ...
                if (c !== (65535 & r.check)) {
                  e.msg = "header crc mismatch", r.mode = O;
                  break;
                }
                c = 0, A = 0;
              }
              r.head && (r.head.hcrc = r.flags >> 9 & 1, r.head.done = true), e.adler = r.check = 0, r.mode = x;
              break;
            case 10:
              for (; A < 32;) {
                if (0 === f) break e;
              ...
              e.adler = r.check = i(c), c = 0, A = 0, r.mode = 11;
            case 11:
              if (0 === r.havedict) return e.next_out = a, e.avail_out = h, e.next_in = s, e.avail_in = f, r.hold = c, r.bits = A, 2;
              e.adler = r.check = 1, r.mode = x;
            case x:
              if (5 === t || 6 === t) break e;
            case 13:
              if (r.last) {
                c >>>= 7 & A, A -= 7 & A, r.mode = 27;
                break;
              }
              for (; A < 3;) {
                if (0 === f) break e;
              ...
              switch (r.last = 1 & c, A -= 1, 3 & (c >>>= 1)) {
                case 0:
                  r.mode = 14;
                  break;
                case 1:
                  if (l(r), r.mode = 20, 6 === t) {
                    c >>>= 2, A -= 2;
                    break e;
                  }
                  break;
                case 2:
                  ...
                  break;
                case 3:
                  e.msg = "invalid block type", r.mode = O;
              }
              c >>>= 2, A -= 2;
              break;
            case 14:
              ...
              if ((65535 & c) != (c >>> 16 ^ 65535)) {
                e.msg = "invalid stored block lengths", r.mode = O;
                break;
              }
              if (r.length = 65535 & c, c = 0, A = 0, r.mode = 15, 6 === t) break e;
            case 15:
              r.mode = 16;
            case 16:
              if (T = r.length) {
                if (T > f && (T = f), T > h && (T = h), 0 === T) break e;
                d.arraySet(o, n, s, T, a), f -= T, s += T, h -= T, a += T, r.length -= T;
                break;
              }
              r.mode = x;
              break;
            case 17:
              ...
              if (r.nlen = 257 + (31 & c), c >>>= 5, A -= 5, r.ndist = 1 + (31 & c), c >>>= 5, A -= 5, r.ncode = 4 + (15 & c), c >>>= 4, A -= 4, r.nlen > 286 || r.ndist > 30) {
                e.msg = "too many length or distance symbols", r.mode = O;
                break;
              }
              r.have = 0, r.mode = 18;
            case 18:
              for (; r.have < r.ncode;) {
                ...
                r.lens[Z[r.have++]] = 7 & c, c >>>= 3, A -= 3;
              }
              for (; r.have < 19;) r.lens[Z[r.have++]] = 0;
              if (r.lencode = r.lendyn, r.lenbits = 7, L = {
                bits: r.lenbits
              }, M = v(0, r.lens, 0, 19, r.lencode, 0, r.work, L), r.lenbits = L.bits, M) {
                e.msg = "invalid code lengths set", r.mode = O;
                break;
              }
              r.have = 0, r.mode = 19;
            case 19:
              for (; r.have < r.nlen + r.ndist;) {
                for (; C = (J = r.lencode[c & (1 << r.lenbits) - 1]) >>> 16 & 255, B = 65535 & J, !((F = J >>> 24) <= A);) {
                  if (0 === f) break e;
                  f--, c += n[s++] << A, A += 8;
                }
                if (B < 16) c >>>= F, A -= F, r.lens[r.have++] = B;else {
                  if (16 === B) {
                    for (z = F + 2; A < z;) {
                      if (0 === f) break e;
                      f--, c += n[s++] << A, A += 8;
                    ...
                    if (c >>>= F, A -= F, 0 === r.have) {
                      e.msg = "invalid bit length repeat", r.mode = O;
                      break;
                    }
                    D = r.lens[r.have - 1], T = 3 + (3 & c), c >>>= 2, A -= 2;
                  } else if (17 === B) {
                    for (z = F + 3; A < z;) {
                      if (0 === f) break e;
                      f--, c += n[s++] << A, A += 8;
                    }
                    A -= F, D = 0, T = 3 + (7 & (c >>>= F)), c >>>= 3, A -= 3;
                  } else {
                    for (z = F + 7; A < z;) {
                      if (0 === f) break e;
                      f--, c += n[s++] << A, A += 8;
                    }
                    A -= F, D = 0, T = 11 + (127 & (c >>>= F)), c >>>= 7, A -= 7;
                  }
                  if (r.have + T > r.nlen + r.ndist) {
                    e.msg = "invalid bit length repeat", r.mode = O;
                    break;
                  }
                  for (; T--;) r.lens[r.have++] = D;
                }
              }
              if (r.mode === O) break;
              if (0 === r.lens[256]) {
                e.msg = "invalid code -- missing end-of-block", r.mode = O;
                break;
              }
              if (r.lenbits = 9, L = {
                bits: r.lenbits
              }, M = v(b, r.lens, 0, r.nlen, r.lencode, 0, r.work, L), r.lenbits = L.bits, M) {
                e.msg = "invalid literal/lengths set", r.mode = O;
                break;
              }
              if (r.distbits = 6, r.distcode = r.distdyn, L = {
                bits: r.distbits
              }, M = v(g, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, L), r.distbits = L.bits, M) {
                e.msg = "invalid distances set", r.mode = O;
                break;
              }
            ...
            case 21:
              if (f >= 6 && h >= 258) {
                e.next_out = a, e.avail_out = h, e.next_in = s, e.avail_in = f, r.hold = c, r.bits = A, m(e, j), a = e.next_out, o = e.output, h = e.avail_out, s = e.next_in, n = e.input, f = e.avail_in, c = r.hold, A = r.bits, r.mode === x && (r.back = -1);
                break;
              }
              for (r.back = 0; C = (J = r.lencode[c & (1 << r.lenbits) - 1]) >>> 16 & 255, B = 65535 & J, !((F = J >>> 24) <= A);) {
                if (0 === f) break e;
                f--, c += n[s++] << A, A += 8;
              }
              if (C && !(240 & C)) {
                for (I = F, P = C, R = B; C = (J = r.lencode[R + ((c & (1 << I + P) - 1) >> I)]) >>> 16 & 255, B = 65535 & J, !(I + (F = J >>> 24) <= A);) {
                  if (0 === f) break e;
                  f--, c += n[s++] << A, A += 8;
                }
                c >>>= I, A -= I, r.back += I;
              }
              if (c >>>= F, A -= F, r.back += F, r.length = B, 0 === C) {
                r.mode = 26;
                break;
              }
              if (32 & C) {
            ...
            case 22:
              if (r.extra) {
                ...
                r.length += c & (1 << r.extra) - 1, c >>>= r.extra, A -= r.extra, r.back += r.extra;
              }
              r.was = r.length, r.mode = 23;
            case 23:
              for (; C = (J = r.distcode[c & (1 << r.distbits) - 1]) >>> 16 & 255, B = 65535 & J, !((F = J >>> 24) <= A);) {
                if (0 === f) break e;
                f--, c += n[s++] << A, A += 8;
              }
              if (!(240 & C)) {
                for (I = F, P = C, R = B; C = (J = r.distcode[R + ((c & (1 << I + P) - 1) >> I)]) >>> 16 & 255, B = 65535 & J, !(I + (F = J >>> 24) <= A);) {
                  if (0 === f) break e;
                  f--, c += n[s++] << A, A += 8;
                }
                c >>>= I, A -= I, r.back += I;
              }
              if (c >>>= F, A -= F, r.back += F, 64 & C) {
            ...
            case 24:
              if (r.extra) {
                ...
                r.offset += c & (1 << r.extra) - 1, c >>>= r.extra, A -= r.extra, r.back += r.extra;
              }
              if (r.offset > r.dmax) {
            ...
            case 25:
              ...
              if (T = j - h, r.offset > T) {
                ...
                T > r.wnext ? (T -= r.wnext, E = r.wsize - T) : E = r.wnext - T, T > r.length && (T = r.length), N = r.window;
              } else N = o, E = a - r.offset, T = r.length;
              T > h && (T = h), h -= T, r.length -= T;
              do {
                o[a++] = N[E++];
              } while (--T);
            ...
            case 27:
              if (r.wrap) {
                ...
                if (j -= h, e.total_out += j, r.total += j, j && (e.adler = r.check = r.flags ? y(r.check, o, j, a - j) : p(r.check, o, j, a - j)), j = h, (r.flags ? c : i(c)) !== r.check) {
                  e.msg = "incorrect data check", r.mode = O;
                  break;
                }
                c = 0, A = 0;
              }
            ...
            case 28:
              if (r.wrap && r.flags) {
                ...
                if (c !== (4294967295 & r.total)) {
                  e.msg = "incorrect length check", r.mode = O;
                  break;
                }
                c = 0, A = 0;
              }
          ...
          var r;
          return e && e.state && 2 & (r = e.state).wrap ? (r.head = t, t.done = false, _) : w;
        }, t.inflateSetDictionary = function (e, t) {
          var r,
            i = t.length;
          return e && e.state ? 0 !== (r = e.state).wrap && 11 !== r.mode ? w : 11 === r.mode && p(1, t, i, 0) !== r.check ? -3 : u(e, t, i, i) ? (r.mode = 31, -4) : (r.havedict = 1, _) : w;
        }, t.inflateInfo = "pako inflate (from Nodeca project)";
      }, function (e, t, r) {
        "use strict";

        e.exports = function (e, t, r, i) {
          for (var n = 65535 & e, o = e >>> 16 & 65535, s = 0; 0 !== r;) {
            r -= s = r > 2e3 ? 2e3 : r;
            do {
              o = o + (n = n + t[i++] | 0) | 0;
            } while (--s);
        ...
        e.exports = function (e, t) {
          var r, i, n, o, s, a, f, l, u, h, c, d, p, y, m, v, b, g, _, w, k, x, O, A, S;
          r = e.state, i = e.next_in, A = e.input, n = i + (e.avail_in - 5), o = e.next_out, S = e.output, s = o - (t - e.avail_out), a = o + (e.avail_out - 257), f = r.dmax, l = r.wsize, u = r.whave, h = r.wnext, c = r.window, d = r.hold, p = r.bits, y = r.lencode, m = r.distcode, v = (1 << r.lenbits) - 1, b = (1 << r.distbits) - 1;
          e: do {
            p < 15 && (d += A[i++] << p, p += 8, d += A[i++] << p, p += 8), g = y[d & v];
            t: for (;;) {
              if (d >>>= _ = g >>> 24, p -= _, 0 == (_ = g >>> 16 & 255)) S[o++] = 65535 & g;else {
                if (!(16 & _)) {
                  if (!(64 & _)) {
                    g = y[(65535 & g) + (d & (1 << _) - 1)];
                    continue t;
                ...
                w = 65535 & g, (_ &= 15) && (p < _ && (d += A[i++] << p, p += 8), w += d & (1 << _) - 1, d >>>= _, p -= _), p < 15 && (d += A[i++] << p, p += 8, d += A[i++] << p, p += 8), g = m[d & b];
                r: for (;;) {
                  if (d >>>= _ = g >>> 24, p -= _, !(16 & (_ = g >>> 16 & 255))) {
                    if (!(64 & _)) {
                      g = m[(65535 & g) + (d & (1 << _) - 1)];
                      continue r;
                    }
                  ...
                  if (k = 65535 & g, p < (_ &= 15) && (d += A[i++] << p, (p += 8) < _ && (d += A[i++] << p, p += 8)), (k += d & (1 << _) - 1) > f) {
        ...
        e.exports = function (e, t, r, f, l, u, h, c) {
          ...
          for (A = 1; A < S && 0 === P[A]; A++);
          for (j < A && (j = A), N = 1, x = 1; x <= 15; x++) if (N <<= 1, (N -= P[x]) < 0) return -1;
          if (N > 0 && (0 === e || 1 !== S)) return -1;
          for (R[1] = 0, x = 1; x < 15; x++) R[x + 1] = R[x] + P[x];
          for (O = 0; O < f; O++) 0 !== t[r + O] && (h[R[t[r + O]]++] = O);
          if (0 === e ? (B = D = h, b = 19) : 1 === e ? (B = n, I -= 257, D = o, M -= 257, b = 256) : (B = s, D = a, b = -1), C = 0, O = 0, x = A, v = u, T = j, E = 0, y = -1, m = (F = 1 << j) - 1, 1 === e && F > 852 || 2 === e && F > 592) return 1;
          for (;;) {
            g = x - E, h[O] < b ? (_ = 0, w = h[O]) : h[O] > b ? (_ = D[M + h[O]], w = B[I + h[O]]) : (_ = 96, w = 0), d = 1 << x - E, A = p = 1 << T;
            do {
              l[v + (C >> E) + (p -= d)] = g << 24 | _ << 16 | w;
            } while (0 !== p);
            for (d = 1 << x - 1; C & d;) d >>= 1;
            ...
            if (x > j && (C & m) !== y) {
              ...
              l[y = C & m] = j << 24 | T << 16 | v - u;
            }
          }
          return 0 !== C && (l[v + C] = x - E << 24 | 4194304), c.bits = j, 0;
        };
      }, function (e, t, r) {
        "use strict";
        ...
        a[254] = a[254] = 1, t.string2buf = function (e) {
          ...
          var r,
            ...
            f = t || e.length,
            l = new Array(2 * f);
          for (n = 0, r = 0; r < f;) if ((o = e[r++]) < 128) l[n++] = o;else if ((s = a[o]) > 4) l[n++] = 65533, r += s - 1;else {
        ...
        "undefined" != typeof self && self, e.exports = function (e) {
          ...
          var i = function () {
            ...
            return e.prototype.start = function (e) {
              undefined === e && (e = undefined), this.doStart(false, e);
            }, e.prototype.reverse = function (e) {
              undefined === e && (e = undefined), this.doStart(true, e);
              ...
              undefined === t && (t = false), undefined === r && (r = undefined), this.mReverse = t, this.mRunning = true, this.mStartTime = e.currentTimeMillsecond(), r && (this.mStartTime -= t ? (1 - r / (this.endValue - this.startValue)) * this.duration : r / (this.endValue - this.startValue) * this.duration), this.mCurrentFrication = 0, this.onStart(), this.doFrame();
              ...
              e >= this.duration * this.loops ? (this.mCurrentFrication = 1 === this.fillRule ? 0 : 1, this.mRunning = false) : (this.mCurrentFrication = e % this.duration / this.duration, this.mReverse && (this.mCurrentFrication = 1 - this.mCurrentFrication)), this.onUpdate(this.animatedValue), false === this.mRunning && this.onEnd();
        ...
        t.Player = function () {
          function e(t) {
            (function (e, t) {
              if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            })(this, e), this.loops = 0, this.clearsAfterStop = true, this.fillMode = "Forward", this._asChild = false, this._container = undefined, this._renderer = undefined, this._animator = undefined, this._drawingCanvas = undefined, this._contentMode = "AspectFit", this._videoItem = undefined, this._forwardAnimating = false, this._currentFrame = 0, this._dynamicImage = {}, this._dynamicImageTransform = {}, this._dynamicText = {}, this._onFinished = undefined, this._onFrame = undefined, this._onPercentage = undefined, this._container = "string" == typeof t ? document.querySelector(t) : t, this._asChild = undefined === t, this._init();
          }
          return n(e, [{
            key: "setVideoItem",
            value: function (e) {
            ...
            value: function (e) {
              this._container instanceof HTMLDivElement && (this._container.style.overflowX = this._container.style.overflowY = e ? "hidden" : undefined);
            }
          }, {
            key: "startAnimation",
            value: function (e) {
              this.stopAnimation(false), this._doStart(undefined, e, undefined);
            }
          }, {
            key: "startAnimationWithRange",
            value: function (e, t) {
              this.stopAnimation(false), this._doStart(e, t, undefined);
            }
          }, {
            key: "pauseAnimation",
            value: function () {
            ...
            key: "stopAnimation",
            value: function (e) {
              this._forwardAnimating = false, undefined !== this._animator && this._animator.stop(), undefined === e && (e = this.clearsAfterStop), e && this.clear();
            }
          }, {
            key: "clear",
            value: function () {
            ...
            key: "stepToFrame",
            value: function (e, t) {
              e >= this._videoItem.frames || e < 0 || (this.pauseAnimation(), this._currentFrame = e, this._update(), t && this._doStart(undefined, false, this._currentFrame));
            }
          }, {
            ...
            key: "setImage",
            value: function (e, t, r) {
              this._dynamicImage[t] = e, undefined !== r && r instanceof Array && 6 == r.length && (this._dynamicImageTransform[t] = r);
            }
          }, {
            key: "setText",
            value: function (e, t) {
              var r = "string" == typeof e ? e : e.text,
                n = ("object" === (undefined === e ? "undefined" : i(e)) ? e.size : "14px") || "14px",
                o = ("object" === (undefined === e ? "undefined" : i(e)) ? e.family : "Arial") || "Arial",
                s = ("object" === (undefined === e ? "undefined" : i(e)) ? e.color : "#000000") || "#000000",
                a = ("object" === (undefined === e ? "undefined" : i(e)) ? e.offset : {
                  x: 0,
                  y: 0
                }) || {
                  x: 0,
            ...
            value: function () {
              if (this._container instanceof HTMLDivElement || this._asChild) {
                if (this._container) for (var e = this._container.querySelectorAll("canvas"), t = 0; t < e.length; t++) {
                  var r = e[t];
                  undefined !== r && r.__isPlayer && this._container.removeChild(r);
                }
            ...
            value: function (e, t, r) {
              var i = this;
              this._animator = new s(), undefined !== e ? (this._animator.startValue = Math.max(0, e.location), this._animator.endValue = Math.min(this._videoItem.frames - 1, e.location + e.length), this._animator.duration = (this._animator.endValue - this._animator.startValue + 1) * (1 / this._videoItem.FPS) * 1e3) : (this._animator.startValue = 0, this._animator.endValue = this._videoItem.frames - 1, this._animator.duration = this._videoItem.frames * (1 / this._videoItem.FPS) * 1e3), this._animator.loops = this.loops <= 0 ? Infinity : this.loops, this._animator.fillRule = "Backward" === this.fillMode ? 1 : 0, this._animator.onUpdate = function (e) {
                ...
                i._forwardAnimating = false, true === i.clearsAfterStop && i.clear(), "function" == typeof i._onFinished && i._onFinished();
              }, true === t ? (this._animator.reverse(r), this._forwardAnimating = false) : (this._animator.start(r), this._forwardAnimating = true), this._currentFrame = this._animator.startValue, this._update();
            }
          }, {
            key: "_resize",
            value: function () {
              ...
              if (this._drawingCanvas) {
                ...
                if (t.width >= r.width && t.height >= r.height) this._drawingCanvas.width = t.width, this._drawingCanvas.height = t.height, this._drawingCanvas.style.webkitTransform = this._drawingCanvas.style.transform = "", e = true;else {
              ...
              if (undefined === this._drawingCanvas || true === e) {
                var y = 1,
                  m = 1,
                  v = 0,
                  b = 0,
                  g = {
                    width: undefined !== this._container ? this._container.clientWidth : 0,
                    height: undefined !== this._container ? this._container.clientHeight : 0
                  },
                  _ = this._videoItem.videoSize;
                if ("Fill" === this._contentMode) y = g.width / _.width, m = g.height / _.height;else if ("AspectFit" === this._contentMode || "AspectFill" === this._contentMode) {
            ...
            key: "_update",
            value: function () {
              undefined !== this._videoItem && (this._resize(), this._renderer.drawFrame(this._currentFrame), this._renderer.playAudio(this._currentFrame));
            }
          }]), e;
        }();
      }, function (e, t, r) {
        ...
        t.Renderer = function () {
          function e(t) {
            (function (e, t) {
              if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            })(this, e), this._owner = undefined, this._prepared = false, this._undrawFrame = undefined, this._bitmapCache = undefined, this._soundsQueue = [], this._owner = t;
          }
          return n(e, [{
            key: "dataURLtoBlob",
            value: function (e) {
            ...
            value: function () {
              var e,
                t,
                r = this;
              if (this._prepared = false, this._bitmapCache = undefined, undefined === this._owner._videoItem.images || 0 == Object.keys(this._owner._videoItem.images).length) return this._bitmapCache = {}, void (this._prepared = true);
              undefined === this._bitmapCache && function () {
                r._bitmapCache = {};
                var i = 0,
                  n = 0;
                for (e in r._owner._videoItem.images) {
                  ...
                  if (0 === o.indexOf("iVBO") || 0 === o.indexOf("/9j/2w")) {
                    ...
                    s.onload = function () {
                      ++n == i && (this._prepared = true, "number" == typeof this._undrawFrame && (this.drawFrame(this._undrawFrame), this._undrawFrame = undefined));
                    }.bind(r), s.src = "data:image/png;base64," + o;
                    var a = e.replace(".matte", "");
                    r._bitmapCache[a] = s;
                  } else 0 === o.indexOf("SUQz") && undefined !== window.Howl && (i++, (t = new Howl({
                    ...
                    html5: "Google Inc." === navigator.vendor || undefined,
                    preload: "Google Inc." === navigator.vendor || undefined,
                    format: "Google Inc." === navigator.vendor ? ["mp3"] : undefined
                  })).once("load", function () {
                    ++n == i && (this._prepared = true, "number" == typeof this._undrawFrame && (this.drawFrame(this._undrawFrame), this._undrawFrame = undefined));
                  }.bind(r)), t.on("loaderror", function (e) {}), r._bitmapCache[e] = t);
                }
              }();
            }
          }, {
                ...
                s.forEach(function (i, a) {
                  if (-1 != s[0].imageKey.indexOf(".matte")) {
                    if (-1 == i.imageKey.indexOf(".matte")) {
                      ...
                      null == i.matteKey || null != f.matteKey && 0 != f.matteKey.length && f.matteKey == i.matteKey || (o = true, r.save()), t.drawSprite(i, r, e), o && a == s.length - 1 && (l = n.get(i.matteKey), r.globalCompositeOperation = "destination-in", t.drawSprite(l, r, e), r.globalCompositeOperation = "source-over", r.restore());
              ...
              if (!(f.alpha < .05)) {
                ...
                if ("string" == typeof u) {
                  var h = this._bitmapCache[e.imageKey] || document.createElement("img"),
                    c = undefined,
                    d = undefined;
                  if (0 === u.indexOf("iVBO") || 0 === u.indexOf("/9j/2w") ? h.src = "data:image/png;base64," + u : (h._svgaSrc !== u && (h._svgaSrc = u, h.src = u), c = f.layout.width, d = f.layout.height), this._bitmapCache[e.imageKey] = h, undefined !== f.maskPath && null !== f.maskPath && (this.drawBezier(t, f.maskPath), t.clip()), undefined !== this._owner._dynamicImageTransform[e.imageKey]) {
                    t.save();
                    var p = this._owner._dynamicImageTransform[e.imageKey];
                    t.transform(p[0], p[1], p[2], p[3], p[4], p[5]);
                  }
                  c && d ? t.drawImage(h, 0, 0, c, d) : t.drawImage(h, 0, 0), undefined !== this._owner._dynamicImageTransform[e.imageKey] && t.restore();
                } else if ("object" === (undefined === u ? "undefined" : i(u))) {
                  if (undefined !== f.maskPath && null !== f.maskPath && (f.maskPath._styles = undefined, this.drawBezier(t, f.maskPath), t.clip()), undefined !== this._owner._dynamicImageTransform[e.imageKey]) {
                    t.save();
                    var y = this._owner._dynamicImageTransform[e.imageKey];
                    t.transform(y[0], y[1], y[2], y[3], y[4], y[5]);
                  }
                  t.drawImage(u, 0, 0), undefined !== this._owner._dynamicImageTransform[e.imageKey] && t.restore();
                }
                ...
                if (undefined !== m) {
                  ...
                  t.fillStyle = m.color;
                  var b = undefined !== m.offset && undefined !== m.offset.x ? isNaN(parseFloat(m.offset.x)) ? 0 : parseFloat(m.offset.x) : 0,
                    g = undefined !== m.offset && undefined !== m.offset.y ? isNaN(parseFloat(m.offset.y)) ? 0 : parseFloat(m.offset.y) : 0;
                  t.fillText(m.text, (f.layout.width - v) / 2 + b, f.layout.height / 2 + g);
                }
                t.restore();
              }
            }
            ...
            value: function (e) {
              ...
              if (this._owner._forwardAnimating && this._owner._videoItem.audios instanceof Array) {
                this._owner._videoItem.audios.forEach(function (r) {
                  if (r.startFrame === e && undefined !== t._bitmapCache[r.audioKey] && "function" == typeof t._bitmapCache[r.audioKey].play) {
                    var i = {
                ...
                this._soundsQueue.forEach(function (t) {
                  e >= t.endFrame && (r = true, t.player.stop(t.playID));
            ...
            value: function (e, t) {
              var r = t._styles;
              undefined !== r && (r && r.stroke ? e.strokeStyle = "rgba(" + parseInt(255 * r.stroke[0]) + ", " + parseInt(255 * r.stroke[1]) + ", " + parseInt(255 * r.stroke[2]) + ", " + r.stroke[3] + ")" : e.strokeStyle = "transparent", r && (e.lineWidth = r.strokeWidth || undefined, e.lineCap = r.lineCap || undefined, e.lineJoin = r.lineJoin || undefined, e.miterLimit = r.miterLimit || undefined), r && r.fill ? e.fillStyle = "rgba(" + parseInt(255 * r.fill[0]) + ", " + parseInt(255 * r.fill[1]) + ", " + parseInt(255 * r.fill[2]) + ", " + r.fill[3] + ")" : e.fillStyle = "transparent", r && r.lineDash && e.setLineDash(r.lineDash));
            }
          }, {
            key: "drawBezier",
            value: function (e, t) {
              var r = this;
              e.save(), this.resetShapeStyles(e, t), undefined !== t._transform && null !== t._transform && e.transform(t._transform.a, t._transform.b, t._transform.c, t._transform.d, t._transform.tx, t._transform.ty);
              var i = {
                x: 0,
                y: 0,
                x1: 0,
        ...
        o.sharedParser = new i.Parser(), o.autoload = function (e, t) {
          if ("undefined" != typeof window && "undefined" != typeof document) {
            ...
            } else for (var a = document.querySelectorAll('[src$=".svga"]'), f = 0; f < a.length; f++) e = a[f], o.autoload(e);
          }
        };
      }]);
    }, module.exports = t();
